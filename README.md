...
- `SPLIT_QUESTS`                      - Список технических имен ключевых квестов вашего мода/игры. Когда один из этих квестов будет `is complete`, автосплиттер сделает сплит сегмента таймера.
